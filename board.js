...
// const botPrompts = [
//   "Hi there! Welcome to the Interactive Lottery Chatbot. What would you like to do?\n1: Set up a Lottery Game\n2: Set up a Keno Game\nType 'exit' to quit.",
...
//         //   expectedWinners: Math.round(expectedWinners),
//         //   odds: odds.toFixed(2),
//         //   prize: prize === 0 ? 0 : prize.toFixed(2),
//         //   liability: liability.toFixed(2),
//         // });
...
/// UPDATED 1/14/25 THE FOLLOWING CODE WORKS, HOWEVER, THERE SOME ISSUES WITH KENO 
/// FOR EXMAPLE THE ODDS ARE SLIGHTLY OFF FOR SOME REASON. 
/// TRYING  TO ADD THE TOTALSUMWINNERS TO THE RESULTS SO I CAN USE THAT FOR THE ODDS CALCULATIONS.
/// TOOK OUT JACKPOT FOR KENO AND PRICE POINT AND GROSS SALES
...
function calculateKenoPayout() {
  ...
  for (let matchCount = 0; matchCount <= kenoType; matchCount++) {
    ...
    const expectedWinners = favorableCombinations; // Expected winners are based on favorable combinations
    const odds = totalSumWinners / expectedWinners;
    totalSumWinners += expectedWinners; // Include all winners, even for $0 prize matches
